...
This project contains automated regression tests for the SauceDemo web application.
The tests are executed on Android Chrome using Java, Appium, and TestNG.
...
- Node.js
- Appium
- Android Studio - used for the android emulator setup

---

## How to Run the Tests (Android Emulator)
...
The tests will run on Chrome using the android emulator and execute against:
